\begin{table}[htbp]
    ...
    \bottomrule
    \end{tabular}
    \caption{\rev{Descriptions of the ten novelty categories with examples, used for the comprehensive evaluation in Polycraft. This categorization is orthogonal to the four-way functional novelty taxonomy of \cref{sec:novelty_typology}; a novelty may belong to one or more of these categories.}}
