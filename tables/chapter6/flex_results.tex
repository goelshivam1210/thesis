...
\bottomrule
\end{tabular}
\caption[\FLEX{} performance on novel objects]{\FLEX{} results on novel object instances evaluated using the Panda robot. Training time is reported in hours and time steps in millions. \FLEX{} achieves the highest success rates across all object types while requiring substantially less training time than all RL baselines.}
