...
\centering
\footnotesize
\caption{\label{tab:results_planning} Performance of the planning agent across four tasks. Each task reports pre-novelty (Default) and post-novelty (Fence, Arrow/Spring, Axe) scenarios.}
\begin{tabular}{lcccc}
\toprule
