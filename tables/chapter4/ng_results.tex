...
\centering
\footnotesize
\caption[Planning-agent performance across tasks]{Performance of the planning agent across four tasks. Each task reports pre-novelty (Default) and post-novelty (Fence, Arrow/Spring, Axe) scenarios.}
