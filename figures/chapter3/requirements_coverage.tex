\begin{figure}[t]
    ...
    \begin{tikzpicture}[
        ...
        collabel/.style={anchor=south, align=center, font=\small\bfseries, text width=2.8cm},
    ...
    \caption[Method families measured against the requirements for open-world autonomy]{Method families surveyed in this chapter, measured against the four requirements for open-world autonomy identified in \cref{sec:what_is_required}: detecting and characterizing mismatch (R1), adapting from limited experience (R2), revising representations (R3), and integrating perception, reasoning, learning, and action (R4). The assignments summarize the typical emphasis of each family rather than the capabilities of every individual system. The figure is therefore a comparative overview, not a claim that all methods within a family make identical assumptions.}
