\begin{figure}[htbp]
    ...
    \end{axis}
    \end{tikzpicture}
    \caption{Bar-chart visualization of the cross-robot transfer results reported in \cref{tab:flex_transfer}. The same learned policies are deployed on three robot platforms without retraining; error bars denote one standard deviation. Performance remains consistent across embodiments, demonstrating that the force-space representation enables direct embodiment transfer.}
