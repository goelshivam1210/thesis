\section[Force-Based Articulated-Object Manipulation]{\FLEX{}: Force-Based Learning for Articulated Object Manipulation}
\label{sec:flex}
...
\begin{figure}[t]
    ...
    \begin{subfigure}[t]{0.45\textwidth}
        \centering
        \includegraphics[width=\textwidth]{figures/chapter6/joint_config_pri.png}
        \caption{Prismatic joint}
    \end{subfigure}
    \hfill
    \begin{subfigure}[t]{0.45\textwidth}
        \centering
        \includegraphics[width=\textwidth]{figures/chapter6/joint_config_rev.png}
        \caption{Revolute joint}
    \end{subfigure}
    \caption[Prismatic and revolute joint configurations]{Illustration of the two joint configurations used in \FLEX{}. (a) A prismatic joint allows linear motion along a fixed axis $h_p$. (b) A revolute joint allows rotational motion around an axis $h_r$ with radius $r$. The state representation for each joint type captures the joint axis direction and the current displacement or projected position, providing an object-centric description independent of robot kinematics.}
...
\input{tables/chapter6/flex_results}
\input{figures/chapter6/flex_results_bars}
\input{figures/chapter6/flex_walltime_bars}
...
\input{tables/chapter6/flex_transfer}
\input{figures/chapter6/flex_transfer_bars}
