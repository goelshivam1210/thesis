...
% ============================================================
\section{MDP Specification}\label{app:mdp}
...
% ============================================================
\section{TD3 Hyperparameters}\label{app:td3}

We use Twin Delayed Deep Deterministic Policy Gradient (TD3)~\cite{fujimoto2018addressing}.
...
The best model is selected based on a composite score: $0.5 \times \text{full-arc success rate} + 0.5 \times \text{generalization success rate}$, evaluated every $25$ episodes on in-distribution conditions.
...
% ============================================================
\section{Simulation Evaluation Protocol}\label{app:eval}

\subsection{In-Distribution Evaluation (Table~II in main paper)}
...
\subsection{Path Generalization Evaluation (Table~III in main paper)}
...
\subsection{Ablation: Interaction Descriptor (Table~IV in main paper)}
...
% ============================================================
\section{Hardware Deployment Details}\label{app:hardware}
...
A pixel on the detected mask edge is passed to the robot's grasp service~\cite{spotsdk} for boundary grasp acquisition.
After grasping, the gripper is opened to establish a push-from-edge contact configuration.

\subsection{Impedance-Based Force Probing}

The interaction descriptor $z$ is estimated via impedance-based probing (Algorithm~1 in main paper).
...
\subsection{Impedance Controller Gains}
...
\subsection{Training Seeds and Reproducibility}
