...
\begin{figure}[t]
    \centering
    % PLACEHOLDER: PHO architecture overview (Figure 1 from paper)
    \figplaceholder{\textwidth}{pho\_architecture: simulation training, impedance probing, compliant execution}
...
\begin{figure}[t]
    \centering
    % PLACEHOLDER: State space diagram (Figure 2 from paper)
    \figplaceholder{0.55\textwidth}{pho\_state\_space: path-relative state variables $e^\text{lat}_t$, $e^\theta_t$, velocities}
...
\begin{figure}[t]
    \centering
    % PLACEHOLDER: Chronophotography composites (Figure 3 from paper)
    \figplaceholder{\textwidth}{pho\_realworld: chronophotographic composites of Spot pushing 8.8\,kg and 12.5\,kg}
