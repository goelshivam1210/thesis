...
\begin{figure}[t]
    ...
    \begin{subfigure}[t]{0.45\textwidth}
        \centering
        \includegraphics[width=\textwidth]{figures/chapter5/joint_config_pri.png}
        \caption{Prismatic joint}
    \end{subfigure}
    \hfill
    \begin{subfigure}[t]{0.45\textwidth}
        \centering
        \includegraphics[width=\textwidth]{figures/chapter5/joint_config_rev.png}
...
\begin{figure}[t]
    \centering
    \includegraphics[width=\textwidth]{figures/chapter5/framework_diagram_final.jpeg}
...
\input{tables/chapter5/flex_results}
...
\input{tables/chapter5/flex_transfer}
...
\begin{figure}[t]
    \centering
    \includegraphics[width=\textwidth]{figures/chapter5/illustrative_figure.jpg}
