...
Formally, $S_r = \{ \SymState : \SymState \models \Eff_{\Operator_i} \} \cup \{ \SymState : \SymState \models \Eff_{\hat{\Operator}} \text{ for all } \hat{\Operator} \in \hat{\Operators} \}$, where $\hat{\Operators}$ is defined as in \cref{sec:ipt_def}. 
