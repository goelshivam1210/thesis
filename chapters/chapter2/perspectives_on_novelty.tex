...
% The problem of acting competently when the world departs from expectation is not unique to artificial intelligence.
Any adaptive system that builds internal models of its environment---a foraging animal, a developing child, a scientist revising a theory---must eventually confront experience that its models did not anticipate. 

Psychology, neuroscience, and cognitive science have studied this confrontation for over a century, and their findings offer useful conceptual grounding for the computational problem this dissertation addresses. 

This section reviews that work; the following section turns to how artificial intelligence has formalized learning and adaptation under change. Throughout, we use \emph{novelty} in an informal sense---experience that violates an agent's expectations---and defer the formal definition adopted in this dissertation to \cref{ch:foundations}.
