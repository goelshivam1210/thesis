...
This dissertation addresses a specific subset of the broader open-world problem through three complementary contributions.
...
\Cref{ch:benchmarks} introduces \NovelGridworlds{} and \NovelGym{}, configurable environments that support modular transformations of entities, actions, tasks, and dynamics, together with protocols and metrics for characterizing the impact of novelty and the subsequent course of adaptation.
...
\Cref{ch:rapid_learn} studies action abstractions in which symbolic operators are associated with executable behaviors.
...
\Cref{ch:flex,ch:pho} study interaction abstractions that represent manipulation at the level of object interaction rather than robot-specific control.
