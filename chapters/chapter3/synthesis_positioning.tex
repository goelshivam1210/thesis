...
\Cref{ch:flex,ch:pho} study interaction abstractions, where representing skills at the level of object interaction rather than robot-specific control allows behavior to transfer across objects, physical parameters, and embodiments.
