...
\citet{gobel2026agentic} reach a consistent conclusion, comparing direct language-model planning and stepwise PDDL-simulation-guided language-model planning against a classical planner on Blocksworld.
