% ─────────────────────────────────────────────────────────────────────────────
% Statistical Significance — \NovelGym{}, matching \RAPidLearn{} paper style
% ─────────────────────────────────────────────────────────────────────────────

\subsubsection{Statistical Significance}
\label{sec:ng_stat_sig}

\rev{To demonstrate that the hybrid agents (\RAPidLearn{} family) adapt significantly
...
\footnotesize
\begin{center}
\begin{tabular}{>{\centering}p{4.3cm}>{\centering}p{1.2cm}>{\centering}p{2.1cm}}

\arrayrulecolor{taupegray}\toprule
\textbf{\begin{small}Methods\end{small}} &
{\textbf{\begin{small}$p$-value\end{small}}} &
\makecell{\textbf{Statistically}\\\textbf{significant}}\tabularnewline
\midrule
...
\end{tabular}
\caption[Statistical comparison of adaptation times]{\rev{Results of an unpaired $t$-test between the best-performing hybrid agent
...
\rev{The results confirm that the hybrid architecture adapts significantly faster than
